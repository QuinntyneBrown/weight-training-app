...
export class AppStore {
    ...
    public exerciseById$(id: string): Observable<Exercise> {
        return this._store.select("exercises")
            .map((data: { exercises: Array<Exercise> }) => {
                return pluck({ value: id, items: data.exercises }) as Exercise;
            })
    }
